    ...
    return (
        ...
        <div 
            ...
            <span className='fruits-card__delete-button'>
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="fruits-card__delete-icon">
            ...
            <span className='fruits-card__like'>
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="20" height="20" className={`fruits-card__like-icon ${fruit.isLiked ? "liked" : ""}`}>
